 ...
 */
// 佳明中国区账号及密码
export const GARMIN_USERNAME_DEFAULT = '124925614@qq.com';
export const GARMIN_PASSWORD_DEFAULT = 'Zk340067';
// 佳明国际区区账号及密码
export const GARMIN_GLOBAL_USERNAME_DEFAULT = 'zhuzitie@tom.com';
export const GARMIN_GLOBAL_PASSWORD_DEFAULT = 'Zk340067';
// 佳明迁移数量配置
